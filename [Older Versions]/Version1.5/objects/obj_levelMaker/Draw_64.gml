if(stats){
	...
	draw_text(0,  60, "Player gird pos: "			   + string(obj_player.x div CELL_WIDTH)    + "-" + string(obj_player.y div CELL_HEIGHT));
	draw_text(0,  80, "Player pixel pos: "			   + string(obj_player.x)					+ "-" + string(obj_player.y));
