...
// Raw Hitbox		  || created by same obj || does belong the hit objects list.
if((creator == noone) || (creator == other)  || (ds_list_find_index(hit_objects, other) != -1)
	// If player doesn't exist, exit.
	|| (!instance_exists(obj_player_limbo))) exit;

// When player hits and enemies die: player kills increase
