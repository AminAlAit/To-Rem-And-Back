t_scene_info = [
	...
	[scr_cutscene_instance_create, 712, 151, "Instances", obj_experience],	// Effects upon departure
	...
	[scr_cutscene_instance_create, 856, 319,"Instances", obj_experience],	// Effects upon arrival
	[scr_cutscene_instance_create, 856, 319,"Instances", obj_player_limbo],	// Create Player on trig2
