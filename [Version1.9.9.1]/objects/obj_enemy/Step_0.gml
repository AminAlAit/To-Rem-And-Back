switch(state){
	#region Decide State
	case "decide":
		scr_set_state_sprite(spr_nurse_one, 0, 0);
		...
		#region State Transition
			if(collision_circle(x, y, chase_range, obj_player_native, false, false)) state = "chase";
		#endregion
	break;#endregion
	#region Move State
	case "move":
		...
		if(timeline_running){
			scr_set_state_sprite(spr_nurse_one, 1, 0);
	...
	case "chase":
		...
		#region State Transitions
			...
			if(collision_circle(x, y, chat_range, obj_player_native, false, false)) state = "chat";
			// exit back to the decide state 
			if(!collision_circle(x, y, chase_range, obj_player_native, false, false)) state = "decide";
		#endregion
	break;#endregion
	#region Chat State
	case "chat":
		...
		#region State Transitions
			...
			if(!collision_circle(x, y, chat_range, obj_player_native, false, false)) state = "chase";
		#endregion
	break;#endregion
}